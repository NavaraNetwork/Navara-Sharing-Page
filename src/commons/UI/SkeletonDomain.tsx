  ...
  <div>
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-[40px_minmax(0,_1fr)_40px_40px] gap-4 py-3 border-b last:border-b-0">
        ...
        <div>
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-3/4 mb-2"></div>
          <div className="w-full h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 mb-2"></div>
